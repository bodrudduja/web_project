<?php
	...
	if($rowSelected==1)
	{
		...
		if($rowSelected2==1)
		{
			...
			$sql3 = "SELECT stuff_name,designation,phone FROM hall_stuff WHERE hall='".$hall_name."';";
			...
			if($rowSelected3>0)
			{
				...
				{	
					$data=$data."<tr>"."<td>" . $row3['stuff_name'] . "</td>"."<td>" . $row3['designation'] . "</td>"."<td>" . $row3['phone']."</td>"."</tr>";
}
